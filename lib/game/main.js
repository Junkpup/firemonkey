...
MyGame = ig.Game.extend({
 ...
 StartScreen = ig.Game.extend({    
				...
				init: function() {          
				 ...
				 this.instructText.draw('Controlled forest fires are considered beneficial for forest growth.\n However, uncontrolled, large-scale forest fires can put biodiversity at risk, cause air pollution and water pollution.', ig.system.width - this.title.width-170, 130)
			 }
		});
